  ...
  return (
    <div className="bg-white rounded-md shadow-md text-gray-500 p-2">
        ...
        <form className="flex flex-1">
            <input className="flex-grow rounded-full h-12 focus:outline-none font-medium bg-gray-100 mx-2" type="text" ref={inputRef} placeholder={`What's on you mind,${session?.user.name}?`} ></input>
        ...
        <div className="flex justify-evenly py-2">
            ...
            <p className="font-semibold text-gray-600">Feelin/Activity</p>
            </div>
        </div>
    </div>
  )

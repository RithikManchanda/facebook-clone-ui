  ...
  return (
    <div className="bg-white flex items-center p-2 shadow-md  top-0 sticky z-50 h-16">
        ...
        <div className="flex min-w-fit">
            <Image src="https://cdn2.iconfinder.com/data/icons/social-media-2285/512/1_Facebook_colored_svg_copy-256.png" height={40} width={40}></Image>
        </div>
        ...
        <div className="flex items-center justify-end min-w-fit space-x-2">
            <Image onClick={signOut} src={session?.user.image} height={40} width={40} className="rounded-full cursor-pointer"></Image> 
